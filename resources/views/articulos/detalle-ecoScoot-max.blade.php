...
<body class="bg-white text-[#1c1c1c] antialiased">
    ...
    <main class="max-w-[1200px] mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div>
            ...
            <a id="reserveBtn" href="{{ route('gestionar-vehiculos', ['vehiculo' => 'ecoScoot-max']) }}" class="inline-block rounded-lg bg-black px-6 py-3 text-white">Reservar y pagar</a>
    ...
    <script>
        ...
        function updateLink(){
            ...
            const qs=new URLSearchParams({producto:'eco-scoot-max',duracion:active,precio:String(rates[active])});
